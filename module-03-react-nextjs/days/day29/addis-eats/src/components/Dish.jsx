...
/**
 * EXERCISE 7: Wrap Dish component with React.memo
 * React.memo prevents re-rendering of individual Dish components 
 * when parent state (like category or search term) updates, unless Dish props change.
 */
