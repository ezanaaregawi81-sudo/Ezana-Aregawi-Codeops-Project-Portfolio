...
function Main() {
  ...
  const onRenderDishList = (id, phase, actualDuration, baseDuration) => {
    console.log(
  ...
  return (
    <main>
      ...
      >
        ...
        <h3>
          Total Orders: <strong>{totalCount} Items</strong>
        </h3>
      </div>
      ...
      <Profiler id="DishList" onRender={onRenderDishList}>
        ...
        >
          ...
          {!loading && !error && filteredMenu.length === 0 && <p>No menu items found.</p>}
